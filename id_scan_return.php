...
<body>
    ...
    <div class="container pt-5 mt-5">
        ...
        <div class="row title">
            ...
            <h3 class="text-danger">PLEASE PLACE YOUR BORROWED APPARATUS ON THE ADMINISTRATOR'S DESK CAREFULLY.</h3>
                <br>
    ...
    <script>
        document.getElementById("user_id_form").addEventListener("submit", function(event) {
            ...
            window.location.href = "returning_status.php?user_id_input=" + userId;
        });
    </script>
